...
urlpatterns = [
    ...
    path('list/votingByName/', views.VotingByNameListView.as_view(), name='voting_by_name_list'),
    path('list/voting/orderingByName/', views.orderingVotingByNameListView.as_view(), name='ordering_by_name_list'),
    path('list/voting/orderingByStartDate/', views.orderingVotingByStartDateListView.as_view(), name='ordering_by_startDate_list'),
    path('list/voting/orderingByEndDate/', views.orderingVotingByEndDateListView.as_view(), name='ordering_by_endDate_list'),
